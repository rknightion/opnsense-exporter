...
var featureAvailabilityProbes = []AvailabilityProbe{
	...
	{Feature: BeatsSubsystem, Endpoint: "beatsServiceStatus"},
	{Feature: CollectdSubsystem, Endpoint: "collectdServiceStatus"},
	{Feature: MuninNodeSubsystem, Endpoint: "muninNodeServiceStatus"},
	{Feature: NetSNMPSubsystem, Endpoint: "netSnmpServiceStatus"},
	{Feature: NetdataSubsystem, Endpoint: "netdataServiceStatus"},
	{Feature: NodeExporterSubsystem, Endpoint: "nodeExporterServiceStatus"},
	{Feature: NRPESubsystem, Endpoint: "nrpeServiceStatus"},
	{Feature: PuppetAgentSubsystem, Endpoint: "puppetAgentServiceStatus"},
	{Feature: QemuGuestAgentSubsystem, Endpoint: "qemuGuestAgentServiceStatus"},
	{Feature: TelegrafSubsystem, Endpoint: "telegrafServiceStatus"},
	{Feature: WazuhAgentSubsystem, Endpoint: "wazuhAgentServiceStatus"},
	{Feature: ZabbixAgentSubsystem, Endpoint: "zabbixAgentServiceStatus"},
	{Feature: ZabbixProxySubsystem, Endpoint: "zabbixProxyServiceStatus"},
