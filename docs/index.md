...
description: Comprehensive Prometheus exporter for OPNsense firewalls with 765 metrics across 61 collectors
...
A Prometheus exporter that polls OPNsense REST APIs and exposes 765 metrics across 61 concurrent collectors: firewall statistics, network interfaces, gateways, VPN tunnels, DHCP leases, DNS resolver stats, system resources, hardware temperatures, certificate expiry, and more.
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 765 Prometheus metrics with types, labels, and PromQL examples.
