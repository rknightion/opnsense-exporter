...
description: Prometheus and OpenTelemetry exporter for OPNsense firewalls with 916 metrics across 64 collectors, native OTLP metrics and logs, a syslog receiver, and NetFlow and Zenarmor flow shipping
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 916 Prometheus metrics with types, labels, and PromQL examples.
...
-   :material-puzzle:{ .lg .middle } **Collectors**
    ...
    64 sub-collectors running concurrently, each targeting a specific OPNsense subsystem.
...
- **64 collectors** covering every major OPNsense subsystem
