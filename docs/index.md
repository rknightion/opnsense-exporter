...
description: Prometheus and OpenTelemetry exporter for OPNsense firewalls with 832 metrics across 62 collectors, native OTLP metrics and logs, a syslog receiver, and NetFlow and Zenarmor flow shipping
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 832 Prometheus metrics with types, labels, and PromQL examples.
