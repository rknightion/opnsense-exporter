...
description: Comprehensive Prometheus exporter for OPNsense firewalls with 764 metrics across 61 collectors
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 764 Prometheus metrics with types, labels, and PromQL examples.
