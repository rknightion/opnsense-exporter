...
description: Prometheus and OpenTelemetry exporter for OPNsense firewalls with 910 metrics across 64 collectors, native OTLP metrics and logs, a syslog receiver, and NetFlow and Zenarmor flow shipping
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 910 Prometheus metrics with types, labels, and PromQL examples.
