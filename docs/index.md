---
title: opnsense2otel
description: Prometheus and OpenTelemetry exporter for OPNsense firewalls with 1000 metrics across 65 collectors, native OTLP metrics and logs, a syslog receiver, and NetFlow and Zenarmor flow shipping
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 1000 Prometheus metrics with types, labels, and PromQL examples.
