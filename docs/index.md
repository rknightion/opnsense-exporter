---
title: opnsense2otel
description: Prometheus and OpenTelemetry exporter for OPNsense firewalls with 1048 metrics across 82 collectors, native OTLP metrics and logs, a syslog receiver, and NetFlow and Zenarmor flow shipping
...
-   :material-chart-bar:{ .lg .middle } **Metrics Reference**
    ...
    Browse all 1048 Prometheus metrics with types, labels, and PromQL examples.
