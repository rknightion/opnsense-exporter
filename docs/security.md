...
| configchange | collector switch not recorded | -- | `backupDiff`<br>`GET api/core/backup/diff` | `known` | Diagnostics: Configuration History (`page-diagnostics-configurationhistory`) | wildcard; may include writes | -- |
...
| Beats | default-on (`--exporter.disable-beats` disables) | plugin-gated | `beatsServiceStatus`<br>`GET api/beats/service/status` | `plugin-dependent` | Services: Beats (`page-services-beats`) | wildcard; may include writes | -- |
...
| Collectd | default-on (`--exporter.disable-collectd` disables) | plugin-gated | `collectdServiceStatus`<br>`GET api/collectd/service/status` | `plugin-dependent` | Services: Collectd (`page-services-collectd`) | wildcard; may include writes | -- |
...
| CPU | default-on (`--exporter.disable-cpu` disables) | -- | `cpuUsageStream`<br>`GET api/diagnostics/cpu_usage/stream` | `known` | Lobby: Dashboard (`page-system-login-logout`) | wildcard; may include writes | -- |
...
| Firewall Migration Debt | default-on (`--exporter.disable-firewall-migration` disables) | plugin-gated | `firewallMigrationOutbound`<br>`GET api/firewall/migration/countOutbound` | `unknown` | No matched ACL; only `page-all` | exact | no ACL pattern in either supported core release covers api/firewall/migration/countOutbound; only page-all is known to reach it. |
| Firewall Migration Debt | default-on (`--exporter.disable-firewall-migration` disables) | plugin-gated | `firewallMigrationRules`<br>`GET api/firewall/migration/countRules` | `unknown` | No matched ACL; only `page-all` | exact | no ACL pattern in either supported core release covers api/firewall/migration/countRules; only page-all is known to reach it. |
...
| Flow Volume | default-on (`--exporter.disable-flow` disables) | -- | `firewallStates`<br>`POST api/diagnostics/firewall/query_states` | `known` | Diagnostics: Show States (`page-diagnostics-showstates`) | wildcard; may include writes | -- |
...
| Gateway Groups | default-on (`--exporter.disable-gateway-groups` disables) | plugin-gated | `gatewayGroups`<br>`GET api/routing/group_settings/search` | `plugin-dependent` | System: Gateways (`page-system-gateways`) | wildcard; may include writes | -- |
...
| Kea DHCP | default-on (`--exporter.disable-kea` disables); high-cardinality opt-in (`--exporter.enable-kea-details`) | -- | `keaReservations4`<br>`GET api/kea/dhcpv4/searchReservation` | `known` | Services: DHCP: Kea(v4) (`page-dhcp-kea-v4`) | wildcard; may include writes | -- |
| Kea DHCP | default-on (`--exporter.disable-kea` disables); high-cardinality opt-in (`--exporter.enable-kea-details`) | -- | `keaReservations6`<br>`GET api/kea/dhcpv6/searchReservation` | `known` | Services: DHCP: Kea(v6) (`page-dhcp-kea-v6`) | wildcard; may include writes | -- |
...
| Munin Node | default-on (`--exporter.disable-munin-node` disables) | plugin-gated | `muninNodeServiceStatus`<br>`GET api/muninnode/service/status` | `plugin-dependent` | Services: Munin-Node (`page-services-muninnode`) | wildcard; may include writes | -- |
...
| Net-SNMP | default-on (`--exporter.disable-net-snmp` disables) | plugin-gated | `netSnmpServiceStatus`<br>`GET api/netsnmp/service/status` | `plugin-dependent` | Services: Net-SNMP (`page-services-netsnmp`) | wildcard; may include writes | -- |
...
| Netdata | default-on (`--exporter.disable-netdata` disables) | plugin-gated | `netdataServiceStatus`<br>`GET api/netdata/service/status` | `plugin-dependent` | Services: Netdata (`page-services-netdata`) | wildcard; may include writes | -- |
...
| Node Exporter | default-on (`--exporter.disable-node-exporter` disables) | plugin-gated | `nodeExporterServiceStatus`<br>`GET api/nodeexporter/service/status` | `plugin-dependent` | Services: Prometheus Exporter (`page-services-nodeexporter`) | wildcard; may include writes | -- |
| NRPE | default-on (`--exporter.disable-nrpe` disables) | plugin-gated | `nrpeServiceStatus`<br>`GET api/nrpe/service/status` | `plugin-dependent` | Services: NRPE (`page-nrpe-config`) | wildcard; may include writes | -- |
...
| pfTop Diagnostics | opt-in (`--exporter.enable-pftop`) | -- | `pfTop`<br>`POST api/diagnostics/firewall/query_pf_top` | `known` | Diagnostics: Firewall sessions (`page-diagnostics-system-pftop`) | exact | The collector also calls interfacesOverview to resolve enabled interface identifiers; grant page-status-interfaces in addition to this endpoint's privilege. |
...
| Puppet Agent | default-on (`--exporter.disable-puppet-agent` disables) | plugin-gated | `puppetAgentServiceStatus`<br>`GET api/puppetagent/service/status` | `plugin-dependent` | Services: Puppet Agent (`page-user-puppetagent`) | wildcard; may include writes | -- |
| QEMU Guest Agent | default-on (`--exporter.disable-qemu-guest-agent` disables) | plugin-gated | `qemuGuestAgentServiceStatus`<br>`GET api/qemuguestagent/service/status` | `plugin-dependent` | Services: QEMU Guest Agent (`page-services-qemuguestagent`) | wildcard; may include writes | -- |
...
| FRR Routing (BGP/OSPF/BFD) | default-on (`--exporter.disable-frr` disables) | plugin-gated | `quaggaBfdSummary`<br>`GET api/quagga/diagnostics/bfdsummary` | `plugin-dependent` | Routing (`page-routing`) | wildcard; may include writes | -- |
...
| FRR Routing (BGP/OSPF/BFD) | default-on (`--exporter.disable-frr` disables) | plugin-gated | `quaggaBgpRoute4`<br>`GET api/quagga/diagnostics/searchBgproute4` | `plugin-dependent` | Routing (`page-routing`) | wildcard; may include writes | -- |
| FRR Routing (BGP/OSPF/BFD) | default-on (`--exporter.disable-frr` disables) | plugin-gated | `quaggaBgpRoute6`<br>`GET api/quagga/diagnostics/searchBgproute6` | `plugin-dependent` | Routing (`page-routing`) | wildcard; may include writes | -- |
...
| Kernel Memory (UMA zones and malloc types) | default-on (`--exporter.disable-kernel-memory` disables) | -- | `systemMemory`<br>`GET api/diagnostics/system/memory` | `unknown` | No matched ACL; only `page-all` | exact | the Core ACL's Lobby: Dashboard privilege lists the seven api/diagnostics/system/system_* URLs individually and carries no wildcard; api/diagnostics/system/memory (SystemController::memoryAction) appears in no pattern in either audited core release, so it is covered by no privilege except page-all. Re-checked against core stable/26.7 and master on 2026-07-30. |
...
| Telegraf | default-on (`--exporter.disable-telegraf` disables) | plugin-gated | `telegrafServiceStatus`<br>`GET api/telegraf/service/status` | `plugin-dependent` | Services: Telegraf (`page-services-telegraf`) | wildcard; may include writes | -- |
...
| pfTop Diagnostics | opt-in (`--exporter.enable-pftop`) | -- | `trafficTop`<br>`GET api/diagnostics/traffic/top` | `known` | Reporting: Traffic (`page-status-trafficgraph`) | wildcard; may include writes | The collector resolves this path from interfacesOverview; grant page-status-interfaces in addition to this endpoint's privilege. |
...
| Unbound DNS | default-on (`--exporter.disable-unbound` disables); high-cardinality opt-in (`--exporter.enable-unbound-infra`) | -- | `unboundQueryStatsTotals`<br>`GET api/unbound/overview/totals/512` | `known` | Services: Unbound (`page-services-unbound`); Status: DNS Overview (`page-status-dnsoverview`) | wildcard; may include writes | -- |
...
| Vnstat Traffic Accounting | opt-in (`--exporter.enable-vnstat`) | plugin-gated | `vnstatGetJsonData`<br>`GET api/vnstat/service/get_json_data` | `plugin-dependent` | Services: Vnstat (`page-services-vnstat`) | wildcard; may include writes | -- |
...
| Wazuh Agent | default-on (`--exporter.disable-wazuh-agent` disables) | plugin-gated | `wazuhAgentServiceStatus`<br>`GET api/wazuh_agent/service/status` | `plugin-dependent` | Services: Wazuh Agent (`page-services-wazuh_agent`) | wildcard; may include writes | -- |
...
| Zabbix Agent | default-on (`--exporter.disable-zabbix-agent` disables) | plugin-gated | `zabbixAgentServiceStatus`<br>`GET api/zabbixagent/service/status` | `plugin-dependent` | Services: Zabbix Agent (`page-services-zabbixagent`) | wildcard; may include writes | -- |
| Zabbix Proxy | default-on (`--exporter.disable-zabbix-proxy` disables) | plugin-gated | `zabbixProxyServiceStatus`<br>`GET api/zabbixproxy/service/status` | `plugin-dependent` | Services: Zabbix Proxy (`page-services-zabbixproxy`) | wildcard; may include writes | -- |
