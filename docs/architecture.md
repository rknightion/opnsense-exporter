...
This package contains the top-level `Collector` struct and all 59 sub-collectors. Each sub-collector lives in its own file and implements the `CollectorInstance` interface:
