---
title: Collectors
description: Overview of all 68 opnsense2otel collectors, their auto-registration pattern, and configuration options
tags:
  - Monitoring
  - Configuration
---
...
opnsense2otel runs 68 sub-collectors on independent background schedules, each targeting a specific OPNsense subsystem. Poll results are stored in memory; Prometheus scrapes replay that snapshot and make no OPNsense API calls.
