...
description: Overview of all 693 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 693 Prometheus metrics across 58 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **693 metrics** across 58 collectors
