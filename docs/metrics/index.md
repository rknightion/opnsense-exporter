...
description: Overview of all 920 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 920 Prometheus metrics across 65 collectors, covering every major subsystem of the firewall platform.
...
- **920 metrics** across 65 collectors
