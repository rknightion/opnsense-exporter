...
opnsense2otel provides all 1022 Prometheus metrics across 68 collectors, covering every major subsystem of the firewall platform.
...
- **1022 metrics** across 68 collectors
