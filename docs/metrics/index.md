...
description: Overview of all 500 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 500 Prometheus metrics across 42 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **500 metrics** across 42 collectors
