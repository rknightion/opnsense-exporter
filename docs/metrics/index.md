...
description: Overview of all 643 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 643 Prometheus metrics across 55 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **643 metrics** across 55 collectors
