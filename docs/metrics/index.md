...
description: Overview of all 830 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 830 Prometheus metrics across 62 collectors, covering every major subsystem of the firewall platform.
...
- **830 metrics** across 62 collectors
