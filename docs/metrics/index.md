...
opnsense2otel provides all 1010 Prometheus metrics across 65 collectors, covering every major subsystem of the firewall platform.
...
- **1010 metrics** across 65 collectors
