...
description: Overview of all 910 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 910 Prometheus metrics across 64 collectors, covering every major subsystem of the firewall platform.
...
- **910 metrics** across 64 collectors
