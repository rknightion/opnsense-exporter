...
opnsense2otel provides all 1014 Prometheus metrics across 67 collectors, covering every major subsystem of the firewall platform.
...
- **1014 metrics** across 67 collectors
