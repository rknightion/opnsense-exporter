...
description: Overview of all 629 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 629 Prometheus metrics across 54 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **629 metrics** across 54 collectors
