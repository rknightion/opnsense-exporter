...
opnsense2otel provides all 1008 Prometheus metrics across 65 collectors, covering every major subsystem of the firewall platform.
...
- **1008 metrics** across 65 collectors
