...
description: Overview of all 928 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 928 Prometheus metrics across 65 collectors, covering every major subsystem of the firewall platform.
...
- **928 metrics** across 65 collectors
