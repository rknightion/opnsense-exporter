...
description: Overview of all 683 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 683 Prometheus metrics across 56 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **683 metrics** across 56 collectors
