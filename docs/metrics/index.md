...
description: Overview of all 689 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 689 Prometheus metrics across 57 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **689 metrics** across 57 collectors
