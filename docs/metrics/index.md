...
description: Overview of all 458 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 458 Prometheus metrics across 38 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **458 metrics** across 38 collectors
