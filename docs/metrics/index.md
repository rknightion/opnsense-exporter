...
opnsense2otel provides all 1007 Prometheus metrics across 65 collectors, covering every major subsystem of the firewall platform.
...
- **1007 metrics** across 65 collectors
