...
description: Overview of all 768 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 768 Prometheus metrics across 61 collectors, covering every major subsystem of the firewall platform.
...
- **768 metrics** across 61 collectors
