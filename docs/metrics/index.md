...
description: Overview of all 691 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 691 Prometheus metrics across 58 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **691 metrics** across 58 collectors
