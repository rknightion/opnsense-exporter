...
description: Overview of all 818 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 818 Prometheus metrics across 62 collectors, covering every major subsystem of the firewall platform.
...
- **818 metrics** across 62 collectors
