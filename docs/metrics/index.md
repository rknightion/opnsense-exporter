...
description: Overview of all 662 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 662 Prometheus metrics across 56 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **662 metrics** across 56 collectors
