...
description: Overview of all 885 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 885 Prometheus metrics across 63 collectors, covering every major subsystem of the firewall platform.
...
- **885 metrics** across 63 collectors
