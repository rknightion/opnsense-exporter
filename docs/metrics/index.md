...
description: Overview of all 837 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 837 Prometheus metrics across 62 collectors, covering every major subsystem of the firewall platform.
...
- **837 metrics** across 62 collectors
