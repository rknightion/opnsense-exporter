...
description: Overview of all 697 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 697 Prometheus metrics across 59 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **697 metrics** across 59 collectors
