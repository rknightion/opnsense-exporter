...
description: Overview of all 674 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 674 Prometheus metrics across 56 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **674 metrics** across 56 collectors
