...
description: Overview of all 571 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 571 Prometheus metrics across 47 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **571 metrics** across 47 collectors
