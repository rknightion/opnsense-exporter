...
description: Overview of all 765 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 765 Prometheus metrics across 61 collectors, covering every major subsystem of the firewall platform.
...
- **765 metrics** across 61 collectors
