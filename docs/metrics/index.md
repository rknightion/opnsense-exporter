...
description: Overview of all 799 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 799 Prometheus metrics across 62 collectors, covering every major subsystem of the firewall platform.
...
- **799 metrics** across 62 collectors
