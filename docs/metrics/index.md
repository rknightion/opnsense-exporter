...
opnsense2otel provides all 1046 Prometheus metrics across 82 collectors, covering every major subsystem of the firewall platform.
...
- **1046 metrics** across 82 collectors
