...
opnsense2otel provides all 1018 Prometheus metrics across 67 collectors, covering every major subsystem of the firewall platform.
...
- **1018 metrics** across 67 collectors
