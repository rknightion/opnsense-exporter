...
description: Overview of all 569 Prometheus metrics exposed by the OPNsense Exporter
tags:
  - Prometheus
  - Monitoring
---
...
The OPNsense Exporter provides 569 Prometheus metrics across 47 collectors, covering every major subsystem of the OPNsense firewall platform.
...
- **569 metrics** across 47 collectors
