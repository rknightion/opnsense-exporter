...
opnsense2otel provides all 1035 Prometheus metrics across 81 collectors, covering every major subsystem of the firewall platform.
...
- **1035 metrics** across 81 collectors
