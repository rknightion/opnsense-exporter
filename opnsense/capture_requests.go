...
var captureRequests = map[EndpointName]CaptureRequest{
	...
	"pfTop":                 {ContentType: formContentType, Body: fetchPFTopPayload},
	...
	"crowdsecCollections":   {ContentType: formContentType, Body: bootgridAllRows},
	"crowdsecScenarios":     {ContentType: formContentType, Body: bootgridAllRows},
	"crowdsecParsers":       {ContentType: formContentType, Body: bootgridAllRows},
	"crowdsecPostoverflows": {ContentType: formContentType, Body: bootgridAllRows},
	"crowdsecAppsecConfigs": {ContentType: formContentType, Body: bootgridAllRows},
	"crowdsecAppsecRules":   {ContentType: formContentType, Body: bootgridAllRows},
