...
from builder import Builder, sel, RATE, GW_STATUS, YESNO
...
def build(b: Builder):
    ...
    rtt_thresholds = b.table(
        ...
        renames={
            "name": "Gateway",
            "address": "Address",
            "opnsense_gateways_rtt_low_milliseconds": "RTT Low (ms)",
            "opnsense_gateways_rtt_high_milliseconds": "RTT High (ms)",
        },
        unit_overrides={
            "RTT Low (ms)": "ms",
            "RTT High (ms)": "ms",
    ...
    loss_thresholds = b.table(
        ...
        renames={
            "name": "Gateway",
            "address": "Address",
            "opnsense_gateways_loss_low_percentage": "Loss Low (%)",
            "opnsense_gateways_loss_high_percentage": "Loss High (%)",
        },
        unit_overrides={
            "Loss Low (%)": "percent",
            "Loss High (%)": "percent",
    ...
    flags = b.table(
        ...
        renames={
            "name": "Name",
            "address": "Address",
            "opnsense_gateways_force_down": "Force Down",
            "opnsense_gateways_virtual": "Virtual",
            "opnsense_gateways_dynamic": "Dynamic",
            "opnsense_gateways_priority": "Priority",
        },
        sort_by="Name",
    ...
    probe_cfg = b.table(
        ...
        renames={
            "name": "Gateway",
            "address": "Address",
            "opnsense_gateways_probe_interval_seconds": "Interval (s)",
            "opnsense_gateways_probe_period_seconds": "Period (s)",
            "opnsense_gateways_probe_timeout_seconds": "Timeout (s)",
        },
        unit_overrides={
            "Interval (s)": "s",
            "Period (s)": "s",
