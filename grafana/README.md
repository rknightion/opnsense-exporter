...
`alerts/` contains **57 alert rules** and **14 recording rules**, shipped as **Grafana-managed
...
`alerts/` contains **57 alert rules** covering exporter/instance liveness, collector health,
