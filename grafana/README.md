...
`alerts/` contains **63 alert rules** and **14 recording rules**, shipped as **Grafana-managed
...
`alerts/` contains **63 alert rules** covering exporter/instance liveness, collector health,
