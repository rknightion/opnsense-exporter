...
`alerts/` contains **59 alert rules** and **14 recording rules**, shipped as **Grafana-managed
...
`alerts/` contains **59 alert rules** covering exporter/instance liveness, collector health,
