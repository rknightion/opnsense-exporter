...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 A new answer can occupy capacity held by expired entries even when those keys were never looked up
- [ ] #2 Unexpired entries retain stop-insert protection and rejection counters count only actual refused insertions
<!-- AC:END -->
