...
type CollectorInfo struct {
	...
	EnvVar      string // e.g., "OPN2OTEL_DISABLE_ARP_TABLE"
...
func main() {
	...
	if *checkMode {
		if len(out.stale) > 0 {
			fatal("generated docs are stale, run 'just docs':\n  %s", strings.Join(out.stale, "\n  "))
		}
...
func generateMetricsDoc(out *output, path string, topLevel []MetricInfo, collectors []CollectorInfo, totalMetrics, totalGauges, totalCounters int) {
	...
	b.WriteString("<!-- This file is auto-generated by scripts/docgen. Do not edit manually. Run 'just docs' to regenerate. -->\n\n")
	b.WriteString("# Complete Metrics Reference\n\n")
	b.WriteString("This page provides a complete reference of all Prometheus metrics exposed by opnsense2otel.\n")
...
func generateCollectorReference(out *output, path string, collectors []CollectorInfo) {
	...
	b.WriteString("This page provides a summary of all collectors in opnsense2otel.\n\n")
