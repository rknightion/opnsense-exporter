...
OPNsense REST API and exposes 697 metrics across 59 collectors — firewall and PF
...
A single dynamic dashboard covers all 697 metrics across 35 tabs, auto-hiding
