...
OPNsense REST API and exposes 777 metrics across 62 collectors: firewall and PF
...
A single dynamic dashboard covers all 777 metrics across 41 tabs, auto-hiding
