...
<<<<<<< HEAD
OPNsense REST API and exposes 589 metrics across 47 collectors — firewall and PF
=======
OPNsense REST API and exposes 589 metrics across 47 collectors — firewall and PF
...
<<<<<<< HEAD
A single dynamic dashboard covers all 589 metrics across 30 tabs, auto-hiding
=======
A single dynamic dashboard covers all 589 metrics across 30 tabs, auto-hiding
>>>>>>> worktree-agent-a3ce49f69eab58897
