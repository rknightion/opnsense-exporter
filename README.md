...
OPNsense REST API and exposes 693 metrics across 58 collectors — firewall and PF
...
A single dynamic dashboard covers all 693 metrics across 34 tabs, auto-hiding
