...
Underneath that: 928 metrics across 65 collectors covering firewall and PF statistics,
...
Two cross-linked dynamic dashboards cover all 965 metrics across 47 tabs, auto-hiding tabs and rows
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 928 metrics with types, labels and PromQL |
