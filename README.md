...
Underneath that: 834 metrics across 62 collectors covering firewall and PF statistics,
...
A single dynamic dashboard covers all 834 metrics across 41 tabs, auto-hiding tabs and rows for
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 834 metrics with types, labels and PromQL |
