...
OPNsense REST API and exposes 626 metrics across 53 collectors — firewall and PF
...
A single dynamic dashboard covers all 626 metrics across 32 tabs, auto-hiding
