...
Underneath that: 910 metrics across 64 collectors covering firewall and PF statistics,
...
Two cross-linked dynamic dashboards cover all 947 metrics across 47 tabs, auto-hiding tabs and rows
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 910 metrics with types, labels and PromQL |
| [Collectors](https://m7kni.io/opnsense-exporter/collectors/) | What each of the 64 collectors covers |
