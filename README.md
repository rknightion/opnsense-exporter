...
OPNsense REST API and exposes 371 metrics across 34 collectors — firewall and PF
...
A single dynamic dashboard covers all 371 metrics across 20 tabs, auto-hiding
