...
Underneath that: 1000 metrics across 65 collectors covering firewall and PF statistics,
...
Two cross-linked dynamic dashboards cover all 1040 metrics across 47 tabs, auto-hiding tabs and rows
...
| [Metrics reference](https://m7kni.io/opnsense2otel/metrics/metrics/) | All 1000 metrics with types, labels and PromQL |
| [Collectors](https://m7kni.io/opnsense2otel/collectors/) | What each of the 65 collectors covers |
