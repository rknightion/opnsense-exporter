...
OPNsense REST API and exposes 806 metrics across 62 collectors: firewall and PF
...
A single dynamic dashboard covers all 806 metrics across 41 tabs, auto-hiding
