...
OPNsense REST API and exposes 799 metrics across 62 collectors: firewall and PF
...
A single dynamic dashboard covers all 799 metrics across 41 tabs, auto-hiding
