...
OPNsense REST API and exposes 689 metrics across 57 collectors — firewall and PF
...
A single dynamic dashboard covers all 689 metrics across 34 tabs, auto-hiding
