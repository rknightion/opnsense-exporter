...
OPNsense REST API and exposes 691 metrics across 58 collectors — firewall and PF
...
A single dynamic dashboard covers all 691 metrics across 34 tabs, auto-hiding
