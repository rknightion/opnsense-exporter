...
OPNsense REST API and exposes 683 metrics across 56 collectors — firewall and PF
...
A single dynamic dashboard covers all 683 metrics across 34 tabs, auto-hiding
