...
A single dynamic dashboard covers all 829 metrics across 41 tabs, auto-hiding tabs and rows for
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 829 metrics with types, labels and PromQL |
