...
OPNsense REST API and exposes 768 metrics across 61 collectors: firewall and PF
...
A single dynamic dashboard covers all 768 metrics across 40 tabs, auto-hiding
