...
OPNsense REST API and exposes 643 metrics across 55 collectors — firewall and PF
...
A single dynamic dashboard covers all 643 metrics across 33 tabs, auto-hiding
