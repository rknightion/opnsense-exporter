...
Underneath that: 916 metrics across 64 collectors covering firewall and PF statistics,
...
Two cross-linked dynamic dashboards cover all 953 metrics across 47 tabs, auto-hiding tabs and rows
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 916 metrics with types, labels and PromQL |
