...
Underneath that: 853 metrics across 63 collectors covering firewall and PF statistics,
...
Two cross-linked dynamic dashboards cover all 889 metrics across 46 tabs, auto-hiding tabs and rows
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 853 metrics with types, labels and PromQL |
| [Collectors](https://m7kni.io/opnsense-exporter/collectors/) | What each of the 63 collectors covers |
