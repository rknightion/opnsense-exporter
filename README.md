...
OPNsense REST API and exposes 569 metrics across 47 collectors — firewall and PF
...
A single dynamic dashboard covers all 569 metrics across 30 tabs, auto-hiding
