...
OPNsense REST API and exposes 654 metrics across 55 collectors — firewall and PF
...
A single dynamic dashboard covers all 654 metrics across 33 tabs, auto-hiding
