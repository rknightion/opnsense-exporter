...
OPNsense REST API and exposes 629 metrics across 54 collectors — firewall and PF
...
A single dynamic dashboard covers all 629 metrics across 32 tabs, auto-hiding
