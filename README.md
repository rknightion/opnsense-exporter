...
Underneath that: 839 metrics across 62 collectors covering firewall and PF statistics,
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 839 metrics with types, labels and PromQL |
