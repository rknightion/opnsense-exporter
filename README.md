...
OPNsense REST API and exposes 559 metrics across 47 collectors — firewall and PF
...
A single dynamic dashboard covers all 559 metrics across 30 tabs, auto-hiding
