...
Underneath that: 885 metrics across 63 collectors covering firewall and PF statistics,
...
Two cross-linked dynamic dashboards cover all 922 metrics across 46 tabs, auto-hiding tabs and rows
...
| [Metrics reference](https://m7kni.io/opnsense-exporter/metrics/metrics/) | All 885 metrics with types, labels and PromQL |
