...
OPNsense REST API and exposes 322 metrics across 30 collectors — firewall and PF
...
A single dynamic dashboard covers all 307 metrics across 16 tabs, auto-hiding
